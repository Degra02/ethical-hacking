# The code takes a few seconds to start because it needs to find unicode replacements for the characters for a fancy SQLi
import requests, string, binascii, time, unicodedata, random
